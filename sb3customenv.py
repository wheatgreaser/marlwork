...
class GridWorldEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, size: int = 5):
        ...
        self.observation_space = gym.spaces.Dict(
            {
                "agent_locations": gym.spaces.Box(0, 24, shape=(2,), dtype=int),   
                "vertiport_locations": gym.spaces.Box(0, 24, shape=(4,), dtype=int),
                "passenger_path": gym.spaces.Box(0, 24, shape=(4,), dtype=int)
            }
        )
